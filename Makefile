#############################################################################
# Makefile for building: LineDotDot-linux
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = LineDotDot-linux1.0.0
DISTDIR = /home/B612/Devloper/LineDotDot/object/LineDotDot-linux1.0.0
LINK          = g++
...
object/app_infos.o: asset/app_infos.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o object/app_infos.o asset/app_infos.cpp
